// pocketbase/migrations/0009_reingest_memory_cap06.js
// Diagnóstico/contenção: a ingestão RAG das 10 fontes text (criadas 17:02) ficou presa em
// "processing" com 0 chunks vetorizados (searchMemory retorna vazio). putMemories com o MESMO
// payload é no-op (mesma payload_key) — então re-adicionamos o capítulo 6 com marcador [v2]
// (payload_key nova → força novo ciclo de ingestão). Se indexar, replicar para os 10 capítulos.
migrate(
  (app) => {
